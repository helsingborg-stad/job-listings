...
class PostType
{
    ...
    public function registerPostType() : string
    {
        $labels = array(
            ...
            'add_new'             => sprintf(__('Add new %s', 'job-listings'), $this->nameSingular),
            'add_new_item'        => sprintf(__('Add new %s', 'job-listings'), $this->nameSingular),
            'edit_item'           => sprintf(__('Edit %s', 'job-listings'), $this->nameSingular),
            'new_item'            => sprintf(__('New %s', 'job-listings'), $this->nameSingular),
            'view_item'           => sprintf(__('View %s', 'job-listings'), $this->nameSingular),
            'search_items'        => sprintf(__('Search %s', 'job-listings'), $this->namePlural),
            'not_found'           => sprintf(__('No %s found', 'job-listings'), $this->namePlural),
            'not_found_in_trash'  => sprintf(__('No %s found in trash', 'job-listings'), $this->namePlural),
            'parent_item_colon'   => sprintf(__('Parent %s:', 'job-listings'), $this->nameSingular),
